...
from .Xplayer import vc_asst, get_string, inline_mention, add_to_queue, mediainfo, file_download, LOGS, is_url_ok, bash, download, Player, VC_QUEUE
...
async def radio_mirchi(e):
    ...
    await xx.reply(
        f"• Started Radio 📻\n\n• Station : `{song}`",
        file="https://telegra.ph/file/241b753a0e7acdc7f5a80.mp4",
    )
    await xx.delete()
